...
import ProMealTracker from "@/components/fitness/pro-meal-tracker";
import MuscleFrequencyTracker from "@/components/fitness/muscle-frequency-tracker";
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 p-4 max-w-7xl mx-auto space-y-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
          {/* Left Column - Muscle Recovery Tracker */}
          <div className="lg:col-span-3">
            <MuscleFrequencyTracker 
