...
interface BeginnerDayEntryModalProps {
  isOpen: boolean;
  onClose: () => void;
  date: string;
  dayData: DayData;
...
export default function BeginnerDayEntryModal({ isOpen, onClose, date, dayData, onSave, onWorkoutSaved }: BeginnerDayEntryModalProps) {
  const { user } = useAuth();
